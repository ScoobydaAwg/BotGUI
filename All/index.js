...
(function () {
  ...
  function textToSpeech(text) {
    ...
    if ('speechSynthesis' in window) {
      ...
      utterance.rate = 1; // Speed of speech, range from 0.1 to 10
      utterance.pitch = 1; // Pitch of speech, range from 0 (lowest) to 2 (highest)
      utterance.volume = 1; // Volume, range from 0 to 1

      // Choose voice (optional)
      // Uncomment the following lines to see available voices and select one
      const voices = window.speechSynthesis.getVoices();
      utterance.voice = voices.filter((voice) => voice.lang === 'en-US')[0]; // Example: Select English (US)
      // Speak the text
